...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th8 13, 2023 lúc 10:15 AM
...
CREATE TABLE `chinhanh` (
  `MaCN` varchar(10) NOT NULL CHECK (`MaCN` regexp '^CN[0-9]{4}$'),
  `TenCN` varchar(50) NOT NULL,
  `KhuVuc` varchar(100) DEFAULT NULL,
  `DiaChi` varchar(100) DEFAULT NULL,
  `Email` varchar(50) DEFAULT NULL,
  `Fax` varchar(20) DEFAULT NULL,
  `MaNVQL` varchar(10) DEFAULT NULL CHECK (`MaNVQL` regexp '^(VP|HD)[0-9]{4}$')
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `chinhanh` (`MaCN`, `TenCN`, `KhuVuc`, `DiaChi`, `Email`, `Fax`, `MaNVQL`) VALUES
('CN0001', 'Chi Nhánh Ba Đình', NULL, NULL, NULL, NULL, NULL),
('CN0002', 'Chi Nhánh Đà Nẵng', NULL, NULL, NULL, NULL, NULL),
('CN0003', 'Chi nhánh Long Hải', NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE `chuyendi` (
  `MaTour` varchar(20) NOT NULL CHECK (`MaTour` regexp '^CN[0-9]{4}-[0-9]{6}$'),
...
CREATE TABLE `diemdulich` (
  ...
  `TenDiem` varchar(100) DEFAULT NULL,
  `DiaChi` varchar(100) DEFAULT NULL,
...
--
-- Cấu trúc bảng cho bảng `donvicungcapdichvu`
--

CREATE TABLE `donvicungcapdichvu` (
  `MaDonVi` varchar(10) NOT NULL CHECK (`MaDonVi` regexp '^DV[0-9]{4}$'),
  `TenDonVi` varchar(100) DEFAULT NULL,
  `Email` varchar(50) DEFAULT NULL,
  `DienThoai` varchar(20) DEFAULT NULL,
  `TenNguoiDaiDien` varchar(50) DEFAULT NULL,
  `DienThoaiNguoiDaiDien` varchar(20) DEFAULT NULL,
  `DiaChi` varchar(100) DEFAULT NULL,
  `PhuongXa` varchar(100) DEFAULT NULL,
  `QuanHuyen` varchar(100) DEFAULT NULL,
  `TinhThanh` varchar(100) DEFAULT NULL,
  ...
  `Anh2` varchar(100) DEFAULT NULL,
  `Anh3` varchar(100) DEFAULT NULL,
  `Anh4` varchar(100) DEFAULT NULL,
  `Anh5` varchar(100) DEFAULT NULL,
  `Loai` char(1) DEFAULT NULL CHECK (`Loai` in (1,2,3)),
  `GhiChu` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Cấu trúc bảng cho bảng `donvicungcapdichvuchuyen`
--

CREATE TABLE `donvicungcapdichvuchuyen` (
  `MaTour` varchar(20) NOT NULL CHECK (`MaTour` regexp '^CN[0-9]{4}-[0-9]{6}$'),
  `NgayKhoiHanh` date NOT NULL,
  `STTNgay` int(11) NOT NULL,
  `Loai` int(11) NOT NULL CHECK (`Loai` > 0 and `Loai` < 9),
  `MaDonVi` varchar(10) NOT NULL CHECK (`MaDonVi` regexp '^DV[0-9]{4}$')
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Cấu trúc bảng cho bảng `donvicungcapdichvulienquan`
--
...
--
-- Cấu trúc bảng cho bảng `hanhdonglichtrinhtour`
--

CREATE TABLE `hanhdonglichtrinhtour` (
  `MaTour` varchar(20) NOT NULL CHECK (`MaTour` regexp '^CN[0-9]{4}-[0-9]{6}$'),
  `STTNgay` int(11) NOT NULL,
  `LoaiHanhDong` int(11) NOT NULL CHECK (`LoaiHanhDong` > 0 and `LoaiHanhDong` < 8),
...
--
-- Cấu trúc bảng cho bảng `huongdanvienchuyendi`
--

CREATE TABLE `huongdanvienchuyendi` (
  `MaTour` varchar(20) NOT NULL CHECK (`MaTour` regexp '^CN[0-9]{4}-[0-9]{6}$'),
  `NgayKhoiHanh` date NOT NULL,
  `MaHuongDanVien` varchar(10) NOT NULL CHECK (`MaHuongDanVien` regexp '^HD[0-9]{4}$')
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `khachdoan`
--

CREATE TABLE `khachdoan` (
  `MaDoan` varchar(10) NOT NULL CHECK (`MaDoan` regexp '^KD[0-9]{4}$'),
  `TenCoQuan` varchar(50) DEFAULT NULL,
  `Email` varchar(50) DEFAULT NULL,
  `DienThoai` varchar(20) DEFAULT NULL,
  `DiaChi` varchar(100) DEFAULT NULL,
  `MaDaiDien` varchar(10) DEFAULT NULL CHECK (`MaDaiDien` regexp '^KH[0-9]{4}$')
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `khachdoangomkhachle`
--

CREATE TABLE `khachdoangomkhachle` (
  `MaDoan` varchar(10) NOT NULL CHECK (`MaDoan` regexp '^KD[0-9]{4}$'),
  `MaKhachHang` varchar(10) NOT NULL CHECK (`MaKhachHang` regexp '^KH[0-9]{4}$')
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Cấu trúc bảng cho bảng `kynangnhanvien`
--

CREATE TABLE `kynangnhanvien` (
  `MaNV` varchar(10) NOT NULL CHECK (`MaNV` regexp '^HD[0-9]{4}$'),
  `KyNang` varchar(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `lichtrinhchuyen`
--
...
--
-- Cấu trúc bảng cho bảng `ngaykhoihanhtourdaingay`
--

CREATE TABLE `ngaykhoihanhtourdaingay` (
  `MaTour` varchar(20) NOT NULL CHECK (`MaTour` regexp '^CN[0-9]{4}-[0-9]{6}$'),
  `Ngay` int(11) NOT NULL CHECK (`Ngay` > 0 and `Ngay` < 32)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `ngoaingunhanvien`
--
...
CREATE TABLE `nhanvien` (
  `MaNV` varchar(10) NOT NULL CHECK (`MaNV` regexp '^(VP|HD)[0-9]{4}$'),
  `CMND` varchar(10) DEFAULT NULL,
  `HoTen` varchar(50) DEFAULT NULL,
  `DiaChi` varchar(100) DEFAULT NULL,
  `GioiTinh` char(1) DEFAULT NULL CHECK (`GioiTinh` = 'F' or `GioiTinh` = 'M'),
  `NgaySinh` date DEFAULT NULL,
  `LoaiNV` char(1) DEFAULT NULL CHECK (`LoaiNV` = '1' or `LoaiNV` = '2'),
  `ViTri` varchar(100) DEFAULT NULL,
  `MaCN` varchar(10) DEFAULT NULL CHECK (`MaCN` regexp '^CN[0-9]{4}$')
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `phieudangky` (
  ...
  `GhiChu` text DEFAULT NULL,
  `MaNhanVien` varchar(10) NOT NULL CHECK (`MaNhanVien` regexp '^VP[0-9]{4}$'),
  `MaKhachLe` varchar(10) DEFAULT NULL CHECK (`MaKhachLe` regexp '^KH[0-9]{4}$'),
  `MaDoan` varchar(10) DEFAULT NULL CHECK (`MaDoan` regexp '^KD[0-9]{4}$'),
  `MaTour` varchar(20) NOT NULL CHECK (`MaTour` regexp '^CN[0-9]{4}-[0-9]{6}$'),
  `NgayKhoiHanh` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Cấu trúc bảng cho bảng `sđtchinhanh`
--

CREATE TABLE `sđtchinhanh` (
  `MaCN` varchar(10) NOT NULL CHECK (`MaCN` regexp '^CN[0-9]{4}$'),
...
CREATE TABLE `tour` (
  ...
  `SoKhachTourToiThieu` int(11) DEFAULT NULL,
  `SoKhachTourToiDa` int(11) DEFAULT NULL,
  `GiaVeLeNguoiLon` float DEFAULT NULL,
  `GiaVeLeTreEm` float DEFAULT NULL,
  `GiaVeDoanNguoiLon` float DEFAULT NULL,
  `GiaVeDoanTreEm` float DEFAULT NULL,
  `SoKhachDoanToiThieu` int(11) DEFAULT NULL,
...
INSERT INTO `tour` (`MaTour`, `TenTour`, `Anh`, `NgayBatDau`, `SoKhachTourToiThieu`, `SoKhachTourToiDa`, `GiaVeLeNguoiLon`, `GiaVeLeTreEm`, `GiaVeDoanNguoiLon`, `GiaVeDoanTreEm`, `SoKhachDoanToiThieu`, `SoDem`, `SoNgay`, `MaCN`) VALUES
('CN0001-000002', 'Du lịch Phú Quốc thơ mộng', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 3, NULL);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `tourgomdiadiemthamquan`
--

CREATE TABLE `tourgomdiadiemthamquan` (
  `MaTour` varchar(20) NOT NULL CHECK (`MaTour` regexp '^CN[0-9]{4}-[0-9]{6}$'),
  `STTNgay` int(11) NOT NULL,
  `MaDiemDuLich` int(11) NOT NULL,
...
ALTER TABLE `chinhanh`
  ...
  ADD UNIQUE KEY `TenCN` (`TenCN`),
  ADD KEY `fk_chinhanh_maNVQL` (`MaNVQL`);
...
--
-- Chỉ mục cho bảng `donvicungcapdichvu`
--
ALTER TABLE `donvicungcapdichvu`
  ADD PRIMARY KEY (`MaDonVi`);

--
-- Chỉ mục cho bảng `donvicungcapdichvuchuyen`
--
ALTER TABLE `donvicungcapdichvuchuyen`
  ADD PRIMARY KEY (`MaTour`,`NgayKhoiHanh`,`STTNgay`,`Loai`,`MaDonVi`),
  ADD KEY `fk_donvicungcaplichtrinhchuyen_maDonVi` (`MaDonVi`);

--
-- Chỉ mục cho bảng `donvicungcapdichvulienquan`
--
ALTER TABLE `donvicungcapdichvulienquan`
  ADD PRIMARY KEY (`MaTour`,`MaDiem`,`MaDonVi`),
  ADD KEY `fk_donvicungcapdichvulienquan_maDiem` (`MaDiem`),
  ADD KEY `fk_donvicungcapdichvulienquan_maDonVi` (`MaDonVi`);

--
-- Chỉ mục cho bảng `hanhdonglichtrinhtour`
--
ALTER TABLE `hanhdonglichtrinhtour`
  ADD PRIMARY KEY (`MaTour`,`STTNgay`,`LoaiHanhDong`);

--
-- Chỉ mục cho bảng `huongdanvienchuyendi`
--
ALTER TABLE `huongdanvienchuyendi`
  ADD PRIMARY KEY (`MaTour`,`NgayKhoiHanh`,`MaHuongDanVien`),
  ADD KEY `fk_huongdanvienchuyendi_maHDV` (`MaHuongDanVien`);

--
-- Chỉ mục cho bảng `khachdoan`
--
ALTER TABLE `khachdoan`
  ADD PRIMARY KEY (`MaDoan`);

--
-- Chỉ mục cho bảng `khachdoangomkhachle`
--
ALTER TABLE `khachdoangomkhachle`
  ADD PRIMARY KEY (`MaDoan`,`MaKhachHang`),
  ADD KEY `fk_khachdoangomkhachle_maKhachHang` (`MaKhachHang`);
...
--
-- Chỉ mục cho bảng `kynangnhanvien`
--
ALTER TABLE `kynangnhanvien`
  ADD PRIMARY KEY (`MaNV`,`KyNang`);

--
-- Chỉ mục cho bảng `lichtrinhchuyen`
--
...
--
-- Chỉ mục cho bảng `ngaykhoihanhtourdaingay`
--
ALTER TABLE `ngaykhoihanhtourdaingay`
  ADD PRIMARY KEY (`MaTour`,`Ngay`);

--
-- Chỉ mục cho bảng `ngoaingunhanvien`
--
...
ALTER TABLE `phieudangky`
  ...
  ADD KEY `fk_phieudangky_maNV` (`MaNhanVien`),
  ADD KEY `fk_phieudangky_maKhachLe` (`MaKhachLe`),
  ADD KEY `fk_phieudangky_maDoan` (`MaDoan`),
  ADD KEY `fk_phieudangky_maTour_ngayKhoiHanh` (`MaTour`,`NgayKhoiHanh`);
...
--
-- Chỉ mục cho bảng `sđtchinhanh`
--
ALTER TABLE `sđtchinhanh`
...
ALTER TABLE `tour`
  ...
  ADD KEY `fk_tour_maCN` (`MaCN`);

--
-- Chỉ mục cho bảng `tourgomdiadiemthamquan`
--
ALTER TABLE `tourgomdiadiemthamquan`
  ADD PRIMARY KEY (`MaTour`,`STTNgay`,`MaDiemDuLich`),
  ADD KEY `fk_tourgomdiadiemthamquan_maDiemDuLich` (`MaDiemDuLich`);
...
--
-- AUTO_INCREMENT cho bảng `diemdulich`
--
ALTER TABLE `diemdulich`
...
--
ALTER TABLE `chinhanh`
  ADD CONSTRAINT `fk_chinhanh_maNVQL` FOREIGN KEY (`MaNVQL`) REFERENCES `nhanvien` (`MaNV`);

--
-- Các ràng buộc cho bảng `chuyendi`
--
ALTER TABLE `chuyendi`
  ADD CONSTRAINT `fk_chuyendi_maTour` FOREIGN KEY (`MaTour`) REFERENCES `tour` (`MaTour`);
...
--
-- Các ràng buộc cho bảng `donvicungcapdichvuchuyen`
--
ALTER TABLE `donvicungcapdichvuchuyen`
  ADD CONSTRAINT `fk_donvicungcaplichtrinhchuyen_maDonVi` FOREIGN KEY (`MaDonVi`) REFERENCES `donvicungcapdichvu` (`MaDonVi`),
  ADD CONSTRAINT `fk_donvicungcaplichtrinhchuyen_maTour_ngayKhoiHanh_STTNgay` FOREIGN KEY (`MaTour`,`NgayKhoiHanh`,`STTNgay`) REFERENCES `lichtrinhchuyen` (`MaTour`, `NgayKhoiHanh`, `STTNgay`);

--
-- Các ràng buộc cho bảng `donvicungcapdichvulienquan`
--
ALTER TABLE `donvicungcapdichvulienquan`
  ADD CONSTRAINT `fk_donvicungcapdichvulienquan_maDiem` FOREIGN KEY (`MaDiem`) REFERENCES `diemdulich` (`MaDiem`),
  ADD CONSTRAINT `fk_donvicungcapdichvulienquan_maDonVi` FOREIGN KEY (`MaDonVi`) REFERENCES `donvicungcapdichvu` (`MaDonVi`),
  ADD CONSTRAINT `fk_donvicungcapdichvulienquan_maTour` FOREIGN KEY (`MaTour`) REFERENCES `tour` (`MaTour`);

--
-- Các ràng buộc cho bảng `hanhdonglichtrinhtour`
--
ALTER TABLE `hanhdonglichtrinhtour`
  ADD CONSTRAINT `fk_hanhdonglichtrinhtour_maTour_sttNgay` FOREIGN KEY (`MaTour`,`STTNgay`) REFERENCES `lichtrinhtour` (`MaTour`, `STTNgay`);

--
-- Các ràng buộc cho bảng `huongdanvienchuyendi`
--
ALTER TABLE `huongdanvienchuyendi`
  ADD CONSTRAINT `fk_huongdanvienchuyendi_maHDV` FOREIGN KEY (`MaHuongDanVien`) REFERENCES `nhanvien` (`MaNV`),
  ADD CONSTRAINT `fk_huongdanvienchuyendi_maTour_ngayKhoiHanh` FOREIGN KEY (`MaTour`,`NgayKhoiHanh`) REFERENCES `chuyendi` (`MaTour`, `NgayKhoiHanh`);

--
-- Các ràng buộc cho bảng `khachdoan`
--
ALTER TABLE `khachdoan`
  ADD CONSTRAINT `fk_khachdoan_maDoan` FOREIGN KEY (`MaDoan`) REFERENCES `khachhang` (`MaKhachHang`);

--
-- Các ràng buộc cho bảng `khachdoangomkhachle`
--
ALTER TABLE `khachdoangomkhachle`
  ADD CONSTRAINT `fk_khachdoangomkhachle_maDoan` FOREIGN KEY (`MaDoan`) REFERENCES `khachdoan` (`MaDoan`),
  ADD CONSTRAINT `fk_khachdoangomkhachle_maKhachHang` FOREIGN KEY (`MaKhachHang`) REFERENCES `khachhang` (`MaKhachHang`);

--
-- Các ràng buộc cho bảng `kynangnhanvien`
--
ALTER TABLE `kynangnhanvien`
  ADD CONSTRAINT `fk_kynangnhanvien_maNV` FOREIGN KEY (`MaNV`) REFERENCES `nhanvien` (`MaNV`);

--
-- Các ràng buộc cho bảng `lichtrinhchuyen`
--
ALTER TABLE `lichtrinhchuyen`
  ADD CONSTRAINT `fk_lichtrinhchuyen_maTour_ngayKhoiHanh` FOREIGN KEY (`MaTour`,`NgayKhoiHanh`) REFERENCES `chuyendi` (`MaTour`, `NgayKhoiHanh`);

--
-- Các ràng buộc cho bảng `lichtrinhtour`
--
ALTER TABLE `lichtrinhtour`
  ADD CONSTRAINT `fk_lichtrinhtour_maTour` FOREIGN KEY (`MaTour`) REFERENCES `tour` (`MaTour`);

--
-- Các ràng buộc cho bảng `ngaykhoihanhtourdaingay`
--
ALTER TABLE `ngaykhoihanhtourdaingay`
  ADD CONSTRAINT `fk_ngaykhoihanhtourdaingay_maTour` FOREIGN KEY (`MaTour`) REFERENCES `tour` (`MaTour`);

--
-- Các ràng buộc cho bảng `ngoaingunhanvien`
--
ALTER TABLE `ngoaingunhanvien`
  ADD CONSTRAINT `fk_ngoaingunhanvien_maNV` FOREIGN KEY (`MaNV`) REFERENCES `nhanvien` (`MaNV`);

--
-- Các ràng buộc cho bảng `nhanvien`
--
ALTER TABLE `nhanvien`
  ADD CONSTRAINT `fk_nhanvien_maCN` FOREIGN KEY (`MaCN`) REFERENCES `chinhanh` (`MaCN`);

--
-- Các ràng buộc cho bảng `phieudangky`
--
ALTER TABLE `phieudangky`
  ADD CONSTRAINT `fk_phieudangky_maDoan` FOREIGN KEY (`MaDoan`) REFERENCES `khachdoan` (`MaDoan`),
  ADD CONSTRAINT `fk_phieudangky_maKhachLe` FOREIGN KEY (`MaKhachLe`) REFERENCES `khachhang` (`MaKhachHang`),
  ADD CONSTRAINT `fk_phieudangky_maNV` FOREIGN KEY (`MaNhanVien`) REFERENCES `nhanvien` (`MaNV`),
  ADD CONSTRAINT `fk_phieudangky_maTour_ngayKhoiHanh` FOREIGN KEY (`MaTour`,`NgayKhoiHanh`) REFERENCES `chuyendi` (`MaTour`, `NgayKhoiHanh`);

--
-- Các ràng buộc cho bảng `sđtchinhanh`
--
ALTER TABLE `sđtchinhanh`
  ADD CONSTRAINT `fk_sđtchinhanh_maCN` FOREIGN KEY (`MaCN`) REFERENCES `chinhanh` (`MaCN`);

--
-- Các ràng buộc cho bảng `tour`
--
ALTER TABLE `tour`
  ADD CONSTRAINT `fk_tour_maCN` FOREIGN KEY (`MaCN`) REFERENCES `chinhanh` (`MaCN`);

--
-- Các ràng buộc cho bảng `tourgomdiadiemthamquan`
--
ALTER TABLE `tourgomdiadiemthamquan`
  ADD CONSTRAINT `fk_tourgomdiadiemthamquan_maDiemDuLich` FOREIGN KEY (`MaDiemDuLich`) REFERENCES `diemdulich` (`MaDiem`),
  ADD CONSTRAINT `fk_tourgomdiadiemthamquan_maTour_sttNgay` FOREIGN KEY (`MaTour`,`STTNgay`) REFERENCES `lichtrinhtour` (`MaTour`, `STTNgay`);
COMMIT;
